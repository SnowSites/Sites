...
const buildTourSteps = (roleTag) => {
    ...
    const hells = [
        { element: 'investigacaoBtn', title: 'Dossiê', content: 'Como  você tem acesso ao Dossiê (organizações/pessoas) para consulta e gestão.' }
    ];
...
const configurarInterfacePorTag = (tag) => {
  ...
  const isStaff = (roleUpper === 'CEO' || roleUpper === 'ADMIN' || (hasOrg && roleUpper !== 'VISITANTE'));
