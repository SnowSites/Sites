...
const toggleView = (viewName) => {
    ...
    if (viewName === 'history') {
        ...
        requestAnimationFrame(() => { monitorOnlineStatus(); /* Inicia o monitoramento de status */ loadAdminPanel(true); /* Garante que a lista de usuários seja carregada */ });
...
els.adminPanelBtn.onclick = () => { toggleView('admin'); if (typeof renderCatalogTextarea === 'function') renderCatalogTextarea(); if (typeof loadCatalogFromDB === 'function') loadCatalogFromDB(); };
